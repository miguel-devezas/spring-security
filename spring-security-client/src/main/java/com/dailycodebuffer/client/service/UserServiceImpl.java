...
public class UserServiceImpl implements UserService {
    ...
    public String validateVerificationToken(String token) {
        ...
        User user = verificationToken.getUser(); // get the user from the token
        Calendar cal = Calendar.getInstance(); // check if the token is expired
    ...
    public String validatePasswordResetToken(String token) {
        ...
        User user = passwordResetToken.getUser(); // get the user from the token
        Calendar cal = Calendar.getInstance(); // check if the token is expired
